...
const ctaPadrao = "Antes de pagar: quem quita pelo SNE, com os 40% de desconto, declara no ato que desiste da defesa prévia e do recurso. Nossa IA analisa o seu auto de infração de graça e mostra se há falha antes de você abrir mão disso.";
...
const ctasPorCategoria: Record<string, string> = {
  ...
  "Pagamento": "O desconto de 40% do SNE tem um custo que não aparece no boleto: ao pagar, você declara que desiste da defesa prévia e do recurso. Nossa IA verifica de graça se o seu auto tem falha — vale saber antes de decidir.",
