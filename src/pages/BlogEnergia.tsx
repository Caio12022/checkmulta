...
export default function BlogEnergia() {
  ...
  useEffect(() => {
    document.title =
      "Blog Energia Elétrica — Contestação de TOI | CheckMulta";
    ...
    const descricao =
      "Guias sobre TOI de energia elétrica: formalidades da inspeção, cálculo da cobrança retroativa e direitos do consumidor.";

    setMeta("description", descricao);
    setMeta("og:title", "Blog Energia Elétrica — Contestação de TOI", true);
    setMeta("og:description", descricao, true);
    setMeta("og:url", "https://checkmulta.com.br/energia/blog", true);
    setMeta("og:type", "website", true);
    setMeta("twitter:title", "Blog Energia Elétrica — Contestação de TOI");
      ...
      <section className="border-b border-slate-100 bg-gradient-to-b from-slate-50 to-white">
        <div className="mx-auto max-w-4xl px-4 py-14 text-center">
          ...
          <h1 className="mb-4 text-3xl font-bold leading-tight text-slate-900 sm:text-4xl">
            ...
            <span className="text-emerald-600">TOI</span> e cobrança retroativa
          </h1>

          <p className="mx-auto max-w-2xl text-base leading-relaxed text-slate-600">
            Formalidades da inspeção, cálculo da cobrança e direitos do
            consumidor. Conteúdo fundamentado na Resolução ANEEL nº 1.000/2021.
          </p>
          ...
          >
            Ver se a minha cobrança tem falha
      ...
      <section className="border-t border-slate-100 bg-slate-50">
        <div className="mx-auto max-w-3xl px-4 py-14 text-center">
          ...
          <p className="mb-6 text-base leading-relaxed text-slate-600">
            Envie o TOI ou a notificação e receba, gratuitamente, a análise que
            aponta se a cobrança tem falha. Se não houver, você não paga nada.
          </p>
          <Link
            to="/energia"
