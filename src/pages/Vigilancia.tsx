...
const calcularViabilidade = (a: Analise | null): Viabilidade | null => {
  ...
  if (a.quantidade_criticos > 0)
    return { nivel: "Alta", cor: "text-red-700", bg: "bg-red-50", borda: "border-red-200" };
  ...
  return (
    <div className="min-h-screen w-full bg-white text-slate-900">
      ...
      <header className="sticky top-0 z-40 border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
          ...
          <nav className="hidden items-center gap-5 text-sm font-medium text-slate-600 lg:flex">
            ...
            <a href="#faq-vigilancia" className="transition hover:text-red-600">Dúvidas</a>
            <a href="/vigilancia-sanitaria/blog" className="transition hover:text-red-600">Blog</a>
            <a href="/multa-de-transito" className="transition hover:text-red-600">Trânsito</a>
            <a href="/procon" className="transition hover:text-red-600">Procon</a>
            <a href="/energia" className="transition hover:text-red-600">Energia</a>
            <a href="/ibama" className="transition hover:text-red-600">IBAMA</a>
            <button
          ...
          <button
            ...
            className="flex rounded-lg p-2 text-slate-600 transition hover:bg-slate-50 hover:text-red-600 lg:hidden"
            aria-label="Menu"
          >
            ...
            {isMobileMenuOpen && (
              ...
              >
                ...
                <button
                  ...
                  className="flex items-center justify-between rounded-lg bg-red-50 px-3 py-3 text-left font-semibold text-red-700 transition"
                >
        ...
        {showFomoBanner && (
          ...
          >
            ...
            <button
              ...
              className="w-full whitespace-nowrap rounded-lg bg-red-600 px-6 py-2.5 text-sm font-semibold text-white transition hover:bg-red-700 sm:w-auto"
            >
              Ver resultado
            </button>
          </motion.div>
      ...
      <div id="inicio">
        <HeroFluxo
          cor="red"
          tagSecao="Para estabelecimentos autuados"
          titulo={
            <>
              Seu estabelecimento foi autuado pela Vigilância Sanitária? Veja se
              dá para recorrer, <span className="text-red-600">grátis</span>
            </>
          }
          descricao={
            <>
              Análise gratuita do auto de infração e dos requisitos do processo
              administrativo sanitário. Se não encontrar falha, você não paga nada.
              <span className="mt-3 flex flex-wrap items-center gap-3 text-sm text-stone-500 sm:gap-5">
                <span className="flex items-center gap-1.5">
                  <ShieldCheck className="h-4 w-4 text-red-600" /> Análise gratuita
                </span>
                <span className="flex items-center gap-1.5">
                  <Lock className="h-4 w-4 text-red-600" /> Sem cadastro
                </span>
                <span className="flex items-center gap-1.5">
                  <Timer className="h-4 w-4 text-red-600" /> Resultado imediato
                </span>
              </span>
            </>
          }
          mensagemChat="Recebi um auto de infração da Vigilância Sanitária e não sei se dá pra recorrer, pode analisar pra mim?"
          rotuloFase2="Cruzar com a norma"
          itensChecklist={[
          ...
          <div className="text-center">
            <div className="mb-8">
              <h2 className="mb-2 text-2xl font-bold text-slate-900 sm:text-3xl">
                Suba <span className="text-red-600">agora</span> o auto e
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              {TIPOS_AUTUACAO.map((t) => (
                <button
                  ...
                  className="group flex flex-col items-center justify-center gap-2.5 rounded-xl border border-slate-200 bg-white p-6 text-slate-800 transition hover:border-red-300 hover:shadow-md"
                >
                  <t.icon className="mb-1 h-8 w-8 text-slate-400 transition group-hover:text-red-600" />
                  <div className="text-center">
                    <span className="block text-[15px] font-bold leading-tight text-slate-900 group-hover:text-red-700">
                      {t.name}
                    </span>
        ...
        <div className="mx-auto max-w-5xl px-4 py-16">
          <div className="mb-10 text-center">
            <h2 className="mb-3 text-2xl font-bold text-slate-900 sm:text-3xl">
              O que verificamos no seu <span className="text-red-600">auto de infração</span>
            </h2>
      ...
      <EscolhaOrgao
        ...
        titulo={
          <>
            Descubra se ela pode ser <span className="text-red-600">anulada</span>
          </>
        }
      ...
      <section id="seguranca" className="border-t border-slate-100 bg-slate-50">
        <div className="mx-auto max-w-5xl px-4 py-16">
          <h2 className="mb-10 text-center text-2xl font-bold text-slate-900 sm:text-3xl">
            Seus dados <span className="text-red-600">100% seguros</span>
          </h2>
      ...
      <section className="border-t border-slate-100 bg-slate-50">
        <div className="mx-auto max-w-3xl px-4 py-16">
          <h2 className="mb-8 text-2xl font-bold leading-tight text-slate-900 sm:text-3xl">
            ...
            <span className="text-red-600">Vigilância Sanitária</span>
          </h2>
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto max-w-4xl px-4 py-10 text-center">
          ...
          <nav className="mb-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm font-medium">
            ...
            <a href="/energia" className="text-slate-600 transition hover:text-red-600">
              Conta de luz
            </a>
            <a href="/ibama" className="text-slate-600 transition hover:text-red-600">
              IBAMA
            </a>
            <a href="/blog" className="text-slate-600 transition hover:text-red-600">
              Blog
            </a>
          </nav>
          ...
          <div className="mt-5 flex justify-center gap-6 text-xs font-medium text-slate-400">
            ...
            <button onClick={() => setActiveModal("suporte")} className="text-red-600 transition hover:text-red-700">Suporte</button>
          </div>
        </div>
      </footer>
      {/* MODAL DE UPLOAD */}
            ...
            <div className="min-h-full flex items-center justify-center p-4">
              ...
              >
                <div className="flex items-center justify-between border-b border-slate-200 px-5 py-4">
                  <div>
                    <p className="mb-0.5 text-[10px] font-semibold uppercase tracking-wide text-red-600">Análise gratuita</p>
                ...
                <div className="space-y-4 p-5">
                  ...
                  <div className="group relative cursor-pointer rounded-lg border-2 border-dashed border-red-300 bg-red-50/30 text-center transition hover:border-red-500 hover:bg-red-50/60">
                    <input
                      type="file"
                      ref={fileInputRef}
                    ...
                    <div className="pointer-events-none flex flex-col items-center justify-center space-y-3 py-8">
                      <div className="flex h-14 w-14 items-center justify-center rounded-full bg-red-600 text-white transition duration-200 group-hover:scale-105">
                  ...
                  {activeModal === "suporte" && (
                    <div className="space-y-5 pt-1">
                      ...
                      <div className="flex flex-col gap-3">
                        <a href="https://wa.me/5513996485501?text=Olá!%20Preciso%20de%20ajuda%20com%20a%20análise%20da%20Vigilância%20Sanitária." target="_blank" rel="noopener noreferrer" className="flex w-full items-center gap-3 rounded-lg border border-red-200 bg-red-50 p-4 text-left text-red-900 transition hover:bg-red-100">
                          <MessageSquare className="h-5 w-5 flex-shrink-0 text-red-600" />
                          <div><strong className="block text-sm font-semibold">Atendimento via WhatsApp</strong><span className="text-xs text-red-700">Fale direto com um analista</span></div>
                        </a>
                ...
                <div className="mt-4 w-full space-y-6">
                  ...
                  {isAnalyzing && (
                    <div className="mx-auto flex max-w-md flex-col items-center justify-center space-y-6 p-6">
                      <div className="mb-2 flex h-20 w-20 items-center justify-center rounded-full bg-red-50 text-red-600">
                      ...
                      <div className="relative h-1.5 w-full overflow-hidden rounded-full bg-slate-100">
                        <motion.div className="absolute left-0 top-0 h-full w-1/2 rounded-full bg-red-600" animate={{ x: ["-100%", "200%"] }} transition={{ repeat: Infinity, duration: 1.5, ease: "easeInOut" }} />
                      </div>
                      <div className="flex min-h-[60px] items-center justify-center">
                        <AnimatePresence mode="wait">
                          <motion.p key={loaderIndex} initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -5 }} transition={{ duration: 0.3 }} className="text-center text-base font-semibold text-red-700">
                  ...
                  {analise && analise.houve_achado && !isPaid && !isAnalyzing && !error && !rejeicaoInfo && (
                    <div className="space-y-6">
                          ...
                          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                            {analise.empresa_autuada && (
                              <div className="flex items-start gap-2.5">
                                <Building2 className="mt-1 h-4 w-4 flex-shrink-0 text-red-600" />
                                <div>
                            ...
                            {analise.orgao_emissor && (
                              <div className="flex items-start gap-2.5">
                                <Scale className="mt-1 h-4 w-4 flex-shrink-0 text-red-600" />
                                <div>
                            ...
                            {analise.numero_processo && (
                              <div className="flex items-start gap-2.5">
                                <FileText className="mt-1 h-4 w-4 flex-shrink-0 text-red-600" />
                                <div>
                      ...
                      <div className="flex items-start space-x-4">
                        <CheckCircle2 className={`mt-1 h-7 w-7 flex-shrink-0 ${viabilidade?.nivel === "Baixa" ? "text-amber-500" : "text-red-600"}`} />
                        <div>
                          <h2 className="mb-2 text-xl font-bold leading-tight text-slate-900 sm:text-2xl">
                            {viabilidade?.nivel === "Baixa" ? (
                              ...
                              <>Encontramos <span className="text-red-600">falha</span> neste auto</>
                            )}
                          </h2>
                        ...
                        <div className="flex items-start gap-3 rounded-lg border border-red-200 bg-red-50 p-4 text-left">
                          ...
                          <div>
                            ...
                            <p className="mt-2 text-sm leading-relaxed text-red-700">
                              O prazo aqui é de 15 dias contados da ciência (art. 22 da Lei 6.437/77). Confira a data de
                      ...
                      <button
                        ...
                        className="flex w-full flex-col items-center justify-center rounded-lg bg-red-600 px-4 py-4 font-semibold text-white transition hover:bg-red-700 disabled:cursor-not-allowed disabled:opacity-75"
                      >
                  ...
                  {isGeneratingDefense && (
                    <div className="mx-auto flex max-w-md flex-col items-center justify-center space-y-6 p-8">
                      ...
                      <div className="w-full rounded-lg border border-red-200 bg-red-50 p-4">
                        <p className="flex items-center justify-center gap-2 text-center text-base font-bold text-red-800">
                          <ShieldCheck className="h-5 w-5" /> Pagamento confirmado
                        </p>
                        <p className="mt-1 text-center text-sm text-red-700">Por favor, aguarde e não feche esta janela.</p>
                      </div>
                    </div>
                  )}
                  ...
                  {defenseError && (
                    <div className="flex flex-col items-center space-y-4 rounded-lg border border-red-200 bg-red-50 p-8 text-center">
                      ...
                      <a href="https://wa.me/5513996485501?text=Olá!%20Eu%20paguei%20pela%20defesa%20da%20Vigilância%20Sanitária%20mas%20a%20tela%20deu%20erro%20ao%20carregar.%20Pode%20me%20ajudar?" target="_blank" rel="noopener noreferrer" className="mt-4 flex items-center gap-2 rounded-lg bg-red-600 px-6 py-3 text-sm font-semibold text-white transition hover:bg-red-700">
                    ...
                    <div className="mx-auto flex w-full max-w-md flex-col items-center space-y-5 p-4 text-center sm:space-y-6 sm:p-10">
                      ...
                      <div className="mt-4 flex w-full flex-col items-center gap-3 sm:mt-6 sm:gap-4">
                        <button
                          ...
                          className="flex w-full items-center justify-center gap-2 rounded-lg bg-red-600 px-4 py-3.5 text-base font-semibold text-white transition hover:bg-red-700"
                        >
                          Ver minha defesa <Check className="h-5 w-5" />
                        </button>
                        <button onClick={() => setActiveModal("suporte")} className="text-sm text-slate-400 transition hover:text-red-600">
                    ...
                    <div className="flex flex-col space-y-6">
                      ...
                      <div className="rounded-r-lg border-l-4 border-red-400 bg-red-50 p-4">
                        <div className="mb-2 flex items-center gap-2">
                          <Send className="h-4 w-4 flex-shrink-0 text-red-700" />
                          <p className="text-sm font-semibold text-red-900">Para onde enviar essa defesa</p>
                        </div>
                        ...
                        <a
                          ...
                          className="mt-2 inline-flex items-center gap-1.5 text-sm font-semibold text-red-700 underline decoration-red-300 underline-offset-4 transition hover:text-red-800 hover:decoration-red-700"
                        >
                      ...
                      <div className="flex flex-col items-center gap-4 border-t border-slate-200 pt-6">
                        <div className="flex w-full flex-col items-center justify-center gap-4 sm:flex-row">
                          <button onClick={handleCopy} className="flex w-full items-center justify-center space-x-2 rounded-lg border border-slate-300 bg-white px-8 py-3.5 text-base font-semibold text-slate-800 transition hover:bg-slate-50 sm:w-auto">
                            {isCopied ? <><Check className="h-5 w-5 text-red-600" /><span className="text-red-600">Copiado</span></> : <><Copy className="h-5 w-5 text-slate-500" /><span>Copiar defesa</span></>}
                          </button>
                          <button onClick={handleDownload} className="flex w-full items-center justify-center space-x-2 rounded-lg bg-red-600 px-8 py-3.5 text-base font-semibold text-white transition hover:bg-red-700 sm:w-auto">
                            <Download className="h-5 w-5" /><span>Baixar .txt</span>
                          </button>
                          <GerarPdfDefesa
                            texto={defenseResult}
                            nomeArquivo="defesa-vigilancia-sanitaria"
                            corBotao="bg-red-600 hover:bg-red-700"
                            onBaixar={() => track("vigilancia_defesa_baixada_pdf", "vigilancia_6_defesa_baixada_pdf")}
                          />
                        </div>
                        <button onClick={() => setActiveModal("suporte")} className="text-sm text-slate-400 transition hover:text-red-600">
                          Precisa de ajuda? Fale com o suporte.
                ...
                <div className="space-y-5 text-center">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-2 rounded-lg border border-slate-200 bg-slate-50 p-2.5">
                      ...
                      <button onClick={handleCopyPix} className="rounded-lg border border-slate-200 bg-white p-2.5 text-slate-700 transition hover:border-red-300 hover:text-red-600">
                        {isPixCopied ? <Check className="h-4 w-4 text-red-600" /> : <Copy className="h-4 w-4" />}
                      </button>
                    </div>
                  ...
                  <div className="flex items-center justify-center gap-2 border-t border-slate-100 pt-4 text-sm font-medium text-slate-500">
                    <RefreshCcw className="h-4 w-4 animate-spin text-red-600" />
            ...
            >
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-xl bg-red-600 px-6 py-3.5 text-sm font-semibold text-white transition hover:bg-red-700"
                >
                  Abrir minha defesa
            ...
            >
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full rounded-xl bg-red-600 px-6 py-3.5 text-sm font-semibold text-white transition hover:bg-red-700"
                >
