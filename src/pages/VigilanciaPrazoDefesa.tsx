...
export default function VigilanciaPrazoDefesa() {
  ...
  useEffect(() => {
    ...
    document.title = "Calculadora de prazo de defesa da Vigilância Sanitária | CheckMulta";
    ...
    canonical.setAttribute(
      "href",
      "https://checkmulta.com.br/vigilancia-sanitaria/prazo-de-defesa"
    );
      ...
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
          ...
          <nav className="flex items-center gap-5 text-sm font-medium text-slate-600">
            <Link to="/vigilancia-sanitaria" className="hover:text-red-600">
              Início
            </Link>
            <Link to="/vigilancia-sanitaria/blog" className="hover:text-red-600">
              Blog
            </Link>
          </nav>
        </div>
      ...
      <main className="mx-auto max-w-3xl px-4 pb-4 pt-8">
        ...
        <span className="mb-8 flex flex-wrap items-center gap-x-3 gap-y-1.5 text-sm text-slate-500">
          <span className="flex items-center gap-1.5">
            <ShieldCheck className="h-4 w-4 text-red-600" /> Cálculo gratuito
          </span>
          <span className="flex items-center gap-1.5">
        ...
        <section className="mb-10">
          ...
          <input
            ...
            className="mb-5 w-full rounded-xl border border-slate-300 bg-white py-3.5 px-4 text-base text-slate-900 outline-none transition focus:border-red-500 focus:ring-2 focus:ring-red-100 sm:w-64"
          />
          ...
          <div className="relative mb-5">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-300 bg-white py-3.5 pl-12 pr-4 text-base text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-red-500 focus:ring-2 focus:ring-red-100 sm:w-64"
            />
          </div>
            ...
            {(
              ...
              <button
                ...
                onClick={() => {
                  ...
                  rastrear("prazo_vigilancia_tipo", { valor });
                }}
        ...
        {resultado && (
          <div className="mb-10 rounded-xl border border-slate-200 bg-white p-5">
            ...
            <Link
              ...
              onClick={() => rastrear("cta_prazo_vigilancia_click", { cta_local: "resultado" })}
        ...
        <section className="mb-9">
          ...
          <p className="mb-4 text-[16.5px] leading-[1.75] text-slate-700">
            A Lei Federal nº 6.437/77 (art. 22) prevê 15 dias, mas isso vale só para autos
            emitidos pela vigilância sanitária federal. Estados e municípios editam códigos
            sanitários próprios, com prazos que variam. Por isso esta calculadora nunca
      ...
      <section className="mt-8 border-t border-slate-100 bg-slate-50/60">
        <div className="mx-auto max-w-3xl px-4 py-12 text-center">
          ...
          <p className="mx-auto mb-6 max-w-xl text-[15px] leading-relaxed text-slate-600">
            Nossa IA lê o auto de infração sanitária e aponta, de graça, se há falha formal.
            Se não houver, você não paga nada.
          </p>
          <Link
            to="/vigilancia-sanitaria?analisar=1"
            onClick={() => rastrear("cta_prazo_vigilancia_click", { cta_local: "final" })}
            className="inline-flex items-center gap-2 rounded-lg bg-red-600 px-7 py-3 text-sm font-semibold text-white transition hover:bg-red-700"
          >
            <ShieldCheck className="h-4 w-4" />
