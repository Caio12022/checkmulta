...
// usada para o artigosIbama.ts, só que sem "sha" - é sempre um arquivo
...
Responda APENAS com um objeto JSON válido, sem markdown, sem crases, sem texto antes ou depois. Formato exato:
{
  ...
  "descricao": "meta description de NO MAXIMO 155 caracteres contando espacos. Comece pela frase que responde a busca. NAO termine com convite generico do tipo 'analise gratis' ou 'verifique gratuitamente' — termine com este fecho exato: Sao 20 dias contados da ciencia da autuacao.",
  "tempoLeitura": "X min",
...
*Este conteúdo tem caráter informativo e não constitui consultoria jurídica. Para orientação sobre o seu caso concreto, consulte um advogado.*`;
  ...
  const seo = ajustarSeoBlog(String(obj.titulo || ""), String(obj.descricao || ""), "ibama");
...
async function produzirArtigo(
  ...
  const violacoesLegais = validarArtigoBlog(String(artigo.conteudo), "ibama", pauta.tema);
