...
const PASTA_IMAGENS = "public/blog/ibama";
const VERTICAL_LABEL = "defesa administrativa de autuações do IBAMA no Brasil";
// "Família visual" fixa pra dar identidade entre as imagens do IBAMA
