...
Responda APENAS com um objeto JSON válido, sem markdown, sem crases, sem texto antes ou depois. Formato exato:
{
  ...
  "descricao": "meta description de NO MAXIMO 155 caracteres contando espacos. Comece pela frase que responde a busca. NAO termine com convite generico do tipo 'analise gratis' ou 'verifique gratuitamente' — termine com este fecho exato: Sem defesa no prazo, vale a revelia.",
  "tempoLeitura": "X min",
...
*Este conteúdo tem caráter informativo e não constitui consultoria jurídica. Para orientação sobre o seu caso concreto, consulte um advogado.*`;
  ...
  const seo = ajustarSeoBlog(String(obj.titulo || ""), String(obj.descricao || ""), "procon");
...
10. NÃO use travessão (—) em nenhum lugar do texto: se encontrar, troque por ponto final com nova frase, ou por vírgula, o que ler melhor.
