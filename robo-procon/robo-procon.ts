...
const PASTA_IMAGENS = "public/blog/procon";
const VERTICAL_LABEL = "defesa administrativa de autuações do Procon no Brasil (empresas autuadas)";
// "Família visual" fixa pra dar identidade entre as imagens do Procon
